      ...
      <section class="content">
        ...
        <div class="row" style="margin-bottom: 10px">
          <!-- <div class="col-md-4">
            ...
            <div class="col">
                <form action="<?php echo site_url('t101_spp/bayarSpp'); ?>" class="form-inline" method="get">
                    <div class="input-group">
                        ...
                        <span class="input-group-btn">
                            <?php
                                ...
                                {
                                    ?>
                                    &nbsp;<a href="<?php echo site_url('t101_spp/bayarSpp'); ?>" class="btn btn-default">Reset</a>&nbsp;
                                    <?php
                                }
                            ?>
        ...
        <table class="table table-bordered" style="margin-bottom: 10px">
            ...
            <tr>
                ...
                echo anchor(site_url('t101_spp/update_2/'.$t101_spp->idsiswa),'Proses');
        				?>
                </td>
		        </tr>
            <?php
